...
for num_layers in num_unfreeze_layers:
    ...
    for model_name in models_to_train:
        ...
        match model_name:
            ...
            case 'vit_b_32':
                ...
                model = ml_modules.create_vit_b_32(len(classes), num_layers)
        ...
        for optimizer_name in optimizers:
            ...
            print(f"[INFO] Unfreeze Layers: {num_layers}")
            print(f"[INFO] Optimizer name: {optimizer_name}")
